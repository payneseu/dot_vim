...
"if !hasmapto( '<Plug>ShowmarksShowMarksToggle' ) | map  <unique> <leader>mt :ShowMarksToggle<cr>|    endif
"if !hasmapto( '<Plug>ShowmarksShowMarksOn'     ) | map  <unique> <leader>mo :ShowMarksOn<cr>|        endif
"if !hasmapto( '<Plug>ShowmarksClearMark'       ) | map  <unique> <leader>mh :ShowMarksClearMark<cr>| endif
"if !hasmapto( '<Plug>ShowmarksClearAll'        ) | map  <unique> <leader>ma :ShowMarksClearAll<cr>|  endif
"if !hasmapto( '<Plug>ShowmarksPlaceMark'       ) | map  <unique> <leader>mm :ShowMarksPlaceMark<cr>| endif
